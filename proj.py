...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'text-align': 'center'}),
    ...
    html.Div(id='output-container', className='output-container', style={'display': 'flex', 'flex-wrap': 'wrap', 'justify-content': 'center'}),])
])
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type', title='Advertisement Expenditure Share by Vehicle Type during Recessions'))
